...
class Testconnectors137486ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS137486_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS137486_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS137486"
